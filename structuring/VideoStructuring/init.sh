...
pip install tensorflow-gpu==1.14 opencv-python torch==1.2.0 torchvision==0.4.0 librosa==0.7.2 tensorboardX==2.1
...
# pip install -i https://pypi.tuna.tsinghua.edu.cn/simple mmcv==1.0.3
