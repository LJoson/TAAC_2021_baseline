...
#     source_movie_fn = '{}.mp4'.format(osp.join(cfg.data_root, "video", cfg.video_name))
    source_movie_fn = '{}.mp4'.format(osp.join(cfg.video_dir, cfg.video_name))
    ...
    out_video_dir_fn = osp.join(cfg.data_root,"scene_video")
    ...
    for scene_ind,scene_item in tqdm(enumerate(scene_list)):
        ...
        out_video_fn = osp.join(out_video_dir_fn,"{}#{:02d}#{:.3f}#{:.3f}#{}.mp4".format(cfg.video_name,
                                                                                 scene_ind,
                                                                                 start_time,
                                                                                 end_time,
                                                                                 int(np.ceil(fps))))
